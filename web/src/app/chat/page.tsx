        ...
        onToken: (token) => {
            setMessages((prev) => {
                ...
                if (lastMessage && lastMessage.role === "assistant") {
                    lastMessage.content = (lastMessage.content as string) + token;
                }
                return newMessages;
            });
        },
        onStatus: (status_text) => {
            console.log("Assistant Status:", status_text);
        },
        onComplete: (data) => {
                    ...
                    <div className="flex justify-between items-center mt-6 px-1">
                        <div className="flex gap-4">
                            <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-emerald-500/10 border border-emerald-500/20">
                                ...
                                <span className="text-[10px] text-emerald-600 font-bold uppercase tracking-widest">Reference Context (PDF) Active</span>
                            </div>
